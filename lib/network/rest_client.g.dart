...
class _RestClient implements RestClient {
  ...
  @override
  Future<ResponseData> getAllAlarm() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseData>(Options(
                ...
                extra: _extra,
                contentType: 'application/json')
            .compose(_dio.options, 'api/alarm',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ResponseData.fromJson(_result.data!);
    return value;
  ...
  @override
  Future<ResponseData> addNewAlarm(alarmTime, flag) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json',
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = {'alarm_time': alarmTime, 'flag_id': flag};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseData>(Options(
                method: 'POST',
                headers: _headers,
  ...
  @override
  Future<ResponseData> updateAlarm(id, flag) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseData>(Options(
                ...
                extra: _extra,
                contentType: 'application/json')
            .compose(_dio.options, 'api/alarm/${id}',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ResponseData.fromJson(_result.data!);
    return value;
